...
typedef struct 
{
    spi_device_handle_t st7796u_handle;  //SPI device handle
    spi_device_interface_config_t st7796u_interface_config; //SPI device configuration
//    spi_bus_config_t st7796u_spi_bus_config; //SPI bus configuration
    spi_transaction_t st7796u_transaction; //SPI transaction structure
}st7796u_config_t;
...
typedef enum
{
    ...
    DISPLAY_DEVICE_ST7796U,
    DISPLAY_DEVICE_SDCARD,
}display_device_e;

typedef struct
{
    spi_bus_config_t display_bus_config;
    st7796u_config_t st7796u_config;
